...
def SMM(inparams, T, epshist, extraparams):
    ...
    sse = np.sum(np.abs(outarray - np.array([2.20, 1.03])))
...
muS =  -1.7352259232545804   # sleeping asymptote for homeostatic process
...
xi = 13.810570860196734          # scaling factor for b(H) function
gamma = .8         # curvature of consumption utility
sig = 0.17656742818784196*1.03/1.010140427189045   # standard deviation of z innovations
