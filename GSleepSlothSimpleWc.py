...
muW = 5.639293967185939          # waking asymptote for homeostatic process
...
xi = 6.333153247833252          # scaling factor for b(H) function
gamma = .8         # curvature of consumption utility
sig = 0.01896254861809632*.5/0.5252504584349367   # standard deviation of z innovations
