...
muS =  -0.8156581125  # sleeping asymptote for homeostatic process
...
xi = 6.916889747619628          # scaling factor for b(H) function
gamma = .8         # curvature of consumption utility
sig = 0.13070654198024234*1./1.039240988499673      # standard deviation of z innovations
