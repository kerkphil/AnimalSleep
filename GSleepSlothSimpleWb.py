...
muW = 3.903071854740765          # waking asymptote for homeostatic process
...
xi = 8.838634327403284           # scaling factor for b(H) function
gamma = .8         # curvature of consumption utility
sig = 0.016282320487208225*.5/0.4348825715191529   # standard deviation of z innovations
